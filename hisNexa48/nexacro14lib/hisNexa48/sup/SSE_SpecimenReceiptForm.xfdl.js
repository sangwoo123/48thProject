    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("SSE_SpecimenReceiptForm");
                this.set_classname("SL_receiptMngnt");
                this.set_titletext("검체접수관리");
                this.set_scrollbars("none");
                this._setFormPosition(0,0,1248,828);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"100\"/><Column id=\"URL\" type=\"STRING\" size=\"100\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">findClinspeReceiptList</Col><Col id=\"inData\"/><Col id=\"URL\">his::sup/endoscoperadiologydiagnosis/findClinspeReceiptList.do</Col><Col id=\"callbackFunc\"/><Col id=\"outData\">dsClinspeReceipt=dsClinspeReceipt</Col></Row><Row><Col id=\"serviceID\">batchClinspeReceiptProcess</Col><Col id=\"URL\">his::sup/endoscoperadiologydiagnosis/batchClinspeReceiptProcess.do</Col><Col id=\"inData\">dsClinspeReceipt=dsClinspeReceipt:U</Col><Col id=\"callbackFunc\"/></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("Div00", "absolute", "0.47%", "8", "1232", "60", null, null, this);
            obj.set_taborder("0");
            obj.style.set_background("transparent URL('img::titleBar1.jpg')");
            this.addChild(obj.name, obj);
            obj = new Static("Static00", "absolute", "6.01%", "-4", null, "60", "76.38%", null, this.Div00);
            obj.set_taborder("0");
            obj.set_text("검체접수관리");
            ...
            obj = new Button("searchFixedAssetMovBtn", "absolute", "1126", "72", "90", "32", null, null, this);
            obj.set_taborder("11");
            ...
            obj = new Grid("clinspeReceiptGrid", "absolute", "1.03%", "112", null, "634", "2.29%", null, this);
            obj.set_taborder("12");
            ...
            obj = new Button("batchClinspeReceiptBtn", "absolute", "1122", "760", "90", "32", null, null, this);
            obj.set_taborder("13");
            obj.set_cssclass("DelBtn");
            ...
            obj = new Button("addClinspeReceiptBtn", "absolute", "914", "761", "90", "32", null, null, this);
            obj.set_taborder("14");
            obj.set_cssclass("DelBtn");
            ...
            obj = new Button("deleteClinspeReceiptBtn", "absolute", "1018", "760", "90", "32", null, null, this);
            obj.set_taborder("15");
            obj.set_cssclass("DelBtn");
            ...
            // Layout Functions
            //-- Default Layout
            obj = new Layout("default", "", 1232, 60, this.Div00,
            	//-- Layout function
            	function(p) {
            		p.set_taborder("0");
            ...
            //-- Default Layout
            obj = new Layout("default", "", 1248, 828, this,
            	//-- Layout function
            	function(p) {
        ...
        // User Script
        this.addIncludeScript("SSE_SpecimenReceiptForm.xfdl", "scripts::commonTransaction.xjs");
        this.addIncludeScript("SSE_SpecimenReceiptForm.xfdl", "scripts::commonScripts.xjs");
        this.addIncludeScript("SSE_SpecimenReceiptForm.xfdl", "scripts::Scripts.xjs");
        this.registerScript("SSE_SpecimenReceiptForm.xfdl", function() {
         /********************************************************************************
        *                                                                                *
        * 검체접수             												         *
        *                                                                                *
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("SSE_SpecimenReceiptForm.xfdl");
