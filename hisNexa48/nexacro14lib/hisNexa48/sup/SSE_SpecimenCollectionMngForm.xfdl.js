    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("SSE_SpecimenCollectionMngForm");
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"100\"/><Column id=\"URL\" type=\"STRING\" size=\"100\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">findClinspeList</Col><Col id=\"URL\">his::sup/endoscoperadiologydiagnosis/findClinspeList.do</Col><Col id=\"outData\">dsClinspe=dsClinspe</Col><Col id=\"callbackFunc\">clinspeCallBack</Col></Row><Row><Col id=\"serviceID\">findMaxClinspeNo</Col><Col id=\"URL\">his::sup/endoscoperadiologydiagnosis/findMaxClinspeNo.do</Col><Col id=\"outData\">dsClinspeSequence=dsClinspeSequence</Col><Col id=\"argument\"/><Col id=\"callbackFunc\">clinspeCallBack</Col></Row><Row><Col id=\"serviceID\">batchClinspeProcess</Col><Col id=\"URL\">his::sup/endoscoperadiologydiagnosis/batchClinspeProcess.do</Col><Col id=\"inData\">dsClinspe=dsClinspe:U</Col><Col id=\"callbackFunc\">clinspeCallBack</Col></Row></Rows>");
            ...
            obj = new Edit("patNoEd", "absolute", "12.88%", "88", null, "28", "75.92%", null, this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new Edit("patNmEd", "absolute", "27.6%", "88", null, "28", "61.2%", null, this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("searchClinspeBtn", "absolute", "1127", "127", "90", "32", null, null, this);
            obj.set_taborder("30");
        ...
        // User Script
        this.addIncludeScript("SSE_SpecimenCollectionMngForm.xfdl", "scripts::commonTransaction.xjs");
        this.addIncludeScript("SSE_SpecimenCollectionMngForm.xfdl", "scripts::commonScripts.xjs");
        this.addIncludeScript("SSE_SpecimenCollectionMngForm.xfdl", "scripts::Scripts.xjs");
        this.registerScript("SSE_SpecimenCollectionMngForm.xfdl", function() {
        /********************************************************************************
        *                                                                               *
        * 검체채취 관리            												    *
        *                                                                               *
        ...
        *********************************************************************************/
        ...
        /********************************************************************************
          폼 로드 이벤트
        ********************************************************************************/
         this.SSP_SpecimenCollectionMngForm_onload = function(obj,e)
         {
        ...
        ********************************************************************************/
        ...
        {
            this.addEventHandler("onload", this.SSP_SpecimenCollectionMngForm_onload, this);
        ...
        this.loadIncludeScript("SSE_SpecimenCollectionMngForm.xfdl");
