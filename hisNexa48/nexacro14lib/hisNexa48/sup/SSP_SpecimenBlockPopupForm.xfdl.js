    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("SSP_SpecimenBlokPopupForm");
            ...
            obj = new Grid("specimenGrid", "absolute", "1.9%", "110", "304", "404", null, null, this);
            obj.set_taborder("2");
        ...
        // User Script
        this.addIncludeScript("SSP_SpecimenBlockPopupForm.xfdl", "scripts::commonTransaction.xjs");
        this.registerScript("SSP_SpecimenBlockPopupForm.xfdl", function() {
        /************************************************************************************
        *                                                                               	*
        * 검체번호 코드 팝업																*
        *                                                                              		*
        ...
        * 검체번호 코드 Grid 이벤트                                  
        ***************************************************************************************************/
        this.specimenGrid_oncelldblclick = function(obj,e)
        {
        ...
        ***************************************************************************************************/
        ...
        {
            this.specimenGrid.addEventHandler("oncelldblclick", this.specimenGrid_oncelldblclick, this);
