    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HA_HospitalizationScheduleForm");
                this.set_classname("WH_HosptlzPatSearchForm");
                this.set_titletext("입원예약폼");
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"256\"/><Column id=\"URL\" type=\"STRING\" size=\"256\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">empInfo</Col><Col id=\"URL\">his::hrs/emp/findEmpList.do</Col><Col id=\"inData\"/><Col id=\"outData\">gdsEmp=gdsEmp</Col><Col id=\"argument\"/><Col id=\"callbackFunc\"/></Row><Row><Col id=\"serviceID\">callhosptlzRsvtSeq</Col><Col id=\"URL\">his::hdm/admission/callhosptlzRsvtSeq.do</Col><Col id=\"outData\">hosptlzRsvtNo=hosptlzRsvtNo</Col><Col id=\"callbackFunc\">callhosptlzRsvtSeqCallbackFunc</Col></Row><Row><Col id=\"serviceID\">registerHospitalizationSchedule</Col><Col id=\"URL\">his::hdm/admission/registerHospitalizationSchedule.do</Col><Col id=\"inData\">dsHospitalizationSchedule=dsHospitalizationSchedule:u </Col><Col id=\"callbackFunc\">registerHosptlzRsvtCallbackFunc</Col></Row></Rows>");
        ...
        // User Script
        this.addIncludeScript("HA_HospitalizationScheduleForm.xfdl", "scripts::commonScripts.xjs");
        this.addIncludeScript("HA_HospitalizationScheduleForm.xfdl", "scripts::wonScripts.xjs");
        this.registerScript("HA_HospitalizationScheduleForm.xfdl", function() {
        /********************************************************************************
        ...
        ********************************************************************************/
        ...
        this.HA_HospitalizationScheduleForm_onload = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onload", this.HA_HospitalizationScheduleForm_onload, this);
        ...
        this.loadIncludeScript("HA_HospitalizationScheduleForm.xfdl");
