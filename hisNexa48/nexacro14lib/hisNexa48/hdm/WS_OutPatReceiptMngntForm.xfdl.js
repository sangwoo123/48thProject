(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.addChild(obj.name, obj);
            obj = new Static("titleStc", "absolute", "45.6%", "0", null, "60", "41.12%", null, this.titleDiv);
            obj.set_taborder("0");
            obj.set_text("외래관리");
            ...
            this.WS_OutPatReceiptMngnDiv.addChild(obj.name, obj);
            obj = new Button("searchPatBtn", "absolute", "26.47%", "44", null, "28", "65.87%", null, this.WS_OutPatReceiptMngnDiv);
        ...
        this.clickBtn = function(obj){	
        	switch(obj){ 
        		...
        		case this.WS_OutPatReceiptMngnDiv.addPatBtn: 	        //신환등록(환자등록)
        			this.clickAddPatBtn();
        			break;	
        		case this.WS_OutPatReceiptMngnDiv.searchZipBtn:         //우편번호 검색
        			this.clickSearchZipBtn();	                        
        			break;
