(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("SearchPatient", "fixed", "26.95%", "64", null, "686", "1.56%", null, this);
            obj.set_taborder("1");
            obj.style.set_background("#eceff1ff");
            obj.style.set_border("1 solid #b0bec5ff");
            obj.style.set_color("#b0bec5ff");
            this.addChild(obj.name, obj);
            obj = new Combo("searchWardCombo", "absolute", "17.81%", "11", "140", "28", null, null, this.SearchPatient);
            ...
            obj = new Edit("Edit00", "absolute", "276", "11", "262", "28", null, null, this.SearchPatient);
            obj.set_taborder("8");
            obj.set_displaynulltext("입력");
            this.SearchPatient.addChild(obj.name, obj);
            obj = new Button("Button00", "absolute", "546", "11", "80", "28", null, null, this.SearchPatient);
            obj.set_taborder("9");
            obj.set_text("검색");
            obj.set_cssclass("btn_WF_CRUD");
            this.SearchPatient.addChild(obj.name, obj);
            obj = new Button("Button01", "absolute", "632", "11", "80", "28", null, null, this.SearchPatient);
            obj.set_taborder("10");
            obj.set_text("재설정");
            obj.set_cssclass("btn_WF_CRUD");
            this.SearchPatient.addChild(obj.name, obj);
            obj = new Grid("PatientGrid", "absolute", "0.82%", "51", null, "627", "0.82%", null, this.SearchPatient);
            obj.set_taborder("12");
            ...
            obj = new Div("SearchPatient00", "fixed", "2.05%", "64", null, "209", "73.83%", null, this);
            obj.set_taborder("45");
            obj.style.set_background("#eceff1ff");
            obj.style.set_border("1 solid #b0bec5ff");
            obj.style.set_color("#b0bec5ff");
            ...
            obj = new Calendar("Calendar00", "absolute", "1.95%", "309", null, "310", "73.83%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("46");
            ...
            obj = new Static("Static00", "absolute", "1.95%", "277", null, "29", "73.83%", null, this);
            obj.set_taborder("48");
            ...
            obj = new Button("Button11", "absolute", "1.95%", "626", null, "123", "73.83%", null, this);
            obj.set_taborder("51");
            ...
            obj = new Static("Static01", "absolute", "14.84%", "627", null, "28", "74.51%", null, this);
            obj.set_taborder("52");
