(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"256\"/><Column id=\"URL\" type=\"STRING\" size=\"256\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">findRsvtList</Col><Col id=\"URL\">his::sup/comprehensiveexam/findSynthesisCheckupReservationList.do</Col><Col id=\"inData\"/><Col id=\"outData\">dsRsvt=dsRsvt</Col><Col id=\"argument\"/><Col id=\"callbackFunc\">callBackFunc</Col></Row><Row><Col id=\"serviceID\">findChoInspList</Col><Col id=\"URL\">his::sup/comprehensiveexam/findChoInspList.do</Col><Col id=\"outData\">dsScct=dsScct dsChoInsp=dsChoInsp</Col><Col id=\"callbackFunc\">callBackFunc</Col><Col id=\"inData\"/></Row><Row><Col id=\"serviceID\">findPckInspList</Col><Col id=\"URL\">his::sup/comprehensiveexam/findPckInspList.do</Col><Col id=\"outData\">dsScct=dsScct</Col><Col id=\"callbackFunc\">callBackFunc</Col></Row><Row><Col id=\"serviceID\">batchSynthesisCheckupReservation</Col><Col id=\"URL\">his::sup/comprehensiveexam/batchSynthesisCheckupReservation.do</Col><Col id=\"inData\">dsRsvt=dsRsvt:U dsChoInsp=dsChoInsp:U</Col><Col id=\"outData\"/><Col id=\"argument\"/><Col id=\"callbackFunc\">supCallBackFunc</Col></Row><Row><Col id=\"serviceID\">findPat</Col><Col id=\"URL\">his::hdm/foreign/findPatList.do</Col><Col id=\"outData\">dsPat=dsPat</Col><Col id=\"argument\"/><Col id=\"callbackFunc\">callBackFunc</Col></Row><Row><Col id=\"serviceID\">cancelCheckupReservation</Col><Col id=\"URL\">his::sup/comprehensiveexam/cancelCheckupReservation.do</Col><Col id=\"callbackFunc\">callBackFunc</Col><Col id=\"outData\"/></Row></Rows>");
            ...
            obj.getSetter("compCheck").set("EsEd");
            this.compBox.addChild(obj.name, obj);
            obj = new Edit("ageEd", "absolute", "38.9%", "87", null, "30", "56.36%", null, this.compBox);
            ...
            this.compBox.addChild(obj.name, obj);
            obj = new Combo("genderCombo", "absolute", "27.68%", "87", null, "30", "62.34%", null, this.compBox);
            this.compBox.addChild(obj.name, obj);
            ...
            obj = new CheckBox("cancelYnChk", "absolute", "89.53%", "234", null, "25", "8.23%", null, this.compBox);
            obj.set_taborder("341");
            obj.set_truevalue("Y");
            obj.set_falsevalue("N");
            this.compBox.addChild(obj.name, obj);

            obj = new Button("addBtn", "absolute", "93.52%", "614", "30", "30", null, null, this);
            obj.set_taborder("7");
            obj.set_text("+");
            obj.style.set_font("16 arial");
            this.addChild(obj.name, obj);

            obj = new Button("delBrn", "absolute", "96.32%", "614", "30", "30", null, null, this);
            obj.set_taborder("8");
            obj.set_text("-");
            obj.style.set_font("16 arial");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("addRsvtBtn", "absolute", "45.28%", "714", null, "24", "47.68%", null, this);
            obj.set_taborder("13");
            obj.set_text("예약");
            obj.style.set_background("#cfd8dcff");
            obj.style.set_color("black");
            ...
            obj = new Button("saveBtn", "absolute", "91.68%", "714", null, "24", "1.28%", null, this);
            obj.set_taborder("15");
            obj.set_text("저장");
            obj.style.set_background("#cfd8dcff");
            obj.style.set_color("black");
            ...
            obj = new Button("cancelBtn", "absolute", "52.72%", "714", null, "24", "40.24%", null, this);
            obj.set_taborder("16");
            obj.set_text("예약취소");
            obj.style.set_background("#cfd8dcff");
            obj.style.set_color("black");
            ...
            obj = new Button("modBtn", "absolute", "84.24%", "714", null, "24", "8.72%", null, this);
            obj.set_taborder("17");
            obj.set_text("수정");
            obj.style.set_background("#cfd8dcff");
            obj.style.set_color("black");
            ...
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item0","compBox.rsvtNoEd","value","dsRsvt","rsvtNo");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item1","compBox.rsvtRespEd","value","dsRsvt","rsvtResp");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item2","compBox.inspDateCal","value","dsRsvt","inspPlnDate");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item3","compBox.inspTimeMask","value","dsRsvt","inspPlnTime");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item4","compBox.pckNmEd","value","dsRsvt","pckNm");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item5","compBox.pckCdEd","value","dsRsvt","pckCd");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item6","compBox.reducCdEd","value","dsRsvt","reducCd");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item7","compBox.reducNmEd","value","dsRsvt","reducNm");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item8","compBox.payManEd","value","dsRsvt","payMan");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item10","compBox.basicInspAmtEd","value","dsRsvt","basicInspAmt");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item11","compBox.reducAmtEd","value","dsRsvt","reducAmt");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item12","compBox.rsvtAmtEd","value","dsRsvt","rsvtAmt");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item13","compBox.basicInspSumAmtEd","value","dsRsvt","basicInspSumAmt");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item14","compBox.memoArea","value","dsRsvt","memo");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item15","compBox.phoneEd","value","dsRsvt","aplManTel");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item16","compBox.rlEd","value","dsRsvt","rship");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item17","compBox.aplMan","value","dsRsvt","aplMan");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item18","compBox.smsEd","value","dsRsvt","sms");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item19","compBox.regNo1Ed","value","dsRsvt","rrn1");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item20","compBox.regNo2Ed","value","dsRsvt","rrn2");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item21","compBox.genderCombo","value","dsRsvt","gender");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item22","compBox.patNmEd","value","dsRsvt","patNm");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item23","compBox.ageEd","value","dsRsvt","age");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item24","compBox.MaskEdit00","value","dsRsvt","rsvtTime");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item25","compBox.rsvtDateEd","value","dsRsvt","rsvtDate");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item26","compBox.patNoEd","value","dsRsvt","patNo");
            this.addChild(obj.name, obj);
            obj.bind();
            obj = new BindItem("item27","compBox.cancelYnChk","value","dsRsvt","cancelYn");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.SSC_SynthesisCheckupReservationForm_onload = function(obj,e)
        {
        ...
        //예약
        this.addRsvtBtn_onclick = function(obj,e)
        {
        ...
        this.cancelBtn_onclick = function(obj,e)
        {
        	if(confirm("예약을 취소하겠습니까?")){
        		...
        		var row = this.dsService.findRow('serviceID' , "cancelCheckupReservation");
        		this.dsService.setColumn(row, "argument", argument);
        							
        		this.gfnService("cancelCheckupReservation",false);
        ...
        /* 선택검사 삭제 */
        this.delBrn_onclick = function(obj,e)
        {
        ...
        this.saveBtn_onclick = function(obj,e)
        {
        	if(this.supCheckMdData(this.compBox))
        	{
        		...
        		this.gfnService("batchSynthesisCheckupReservation",false);
        		this.searchBtn_onclick(null,null);
        	}
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("onload", this.SSC_SynthesisCheckupReservationForm_onload, this);
            ...
            this.delBrn.addEventHandler("onclick", this.delBrn_onclick, this);
            ...
            this.addRsvtBtn.addEventHandler("onclick", this.addRsvtBtn_onclick, this);
