    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("SSP_SpecimenBlockMngForm");
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"256\"/><Column id=\"URL\" type=\"STRING\" size=\"256\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">findClinspeBlokList</Col><Col id=\"URL\">his::sup/pathology/findClinspeBlokList.do</Col><Col id=\"outData\">dsSspClinspeBlok=dsSspClinspeBlok</Col></Row><Row><Col id=\"serviceID\">batchClinspeBlokProcess</Col><Col id=\"URL\">his::sup/pathology/batchClinspeBlokProcess.do</Col><Col id=\"inData\">dsSspClinspeBlok=dsSspClinspeBlok:u</Col></Row></Rows>");
            this.addChild(obj.name, obj);

            obj = new Dataset("dsSspClinspeBlok", this);
            obj.set_firefirstcount("0");
            obj.getSetter("firenextcount").set("0");
            obj.set_useclientlayout("false");
            obj.set_updatecontrol("true");
            ...
            obj.set_taborder("1");
            obj.set_binddataset("dsSspClinspeBlok");
            obj.set_autoenter("select");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"85\"/><Column size=\"126\"/><Column size=\"144\"/><Column size=\"174\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"검체번호\"/><Cell col=\"1\" text=\"검체블록코드\"/><Cell col=\"2\" text=\"검체블록 제작일\"/><Cell col=\"3\" text=\"검체블록 제작시간\"/><Cell col=\"4\" text=\"검체블록 수량\"/><Cell col=\"5\" text=\"환자번호\"/><Cell col=\"6\" text=\"환자명\"/></Band><Band id=\"body\"><Cell edittype=\"text\" style=\"align:center;\" text=\"bind:clinspeNo\"/><Cell col=\"1\" style=\"align:center;\" text=\"bind:clinspeBlokCode\"/><Cell col=\"2\" edittype=\"date\" style=\"align:center;\" text=\"bind:clinspeBlokProdDay\"/><Cell col=\"3\" edittype=\"normal\" style=\"align:center;\" text=\"bind:clinspeBlokProdTime\"/><Cell col=\"4\" edittype=\"text\" style=\"align:center;\" text=\"bind:clinspeBlokQnt\"/><Cell col=\"5\" edittype=\"text\" style=\"align:center;\" text=\"bind:patNo\"/><Cell col=\"6\" edittype=\"text\" style=\"align:center;\" text=\"bind:patNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("SSP_SpecimenBlockMngForm.xfdl", "scripts::commonTransaction.xjs");
        this.addIncludeScript("SSP_SpecimenBlockMngForm.xfdl", "scripts::commonScripts.xjs");
        this.registerScript("SSP_SpecimenBlockMngForm.xfdl", function() {
        /********************************************************************************
        *                                                                               *
        *검체블록  관리																*
        *                                                                               *
