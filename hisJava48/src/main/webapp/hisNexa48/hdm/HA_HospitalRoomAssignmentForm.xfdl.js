    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("HA_HospitalRoomAssignmentForm");
                this.set_classname("WB_HosptlzHroomMngntPopupForm");
                this.set_titletext("HA_HospitalRoomAssignmentForm");
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"256\"/><Column id=\"URL\" type=\"STRING\" size=\"256\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">findHospitalRoomList</Col><Col id=\"URL\">his::hdm/admission/findHospitalRoomList.do</Col><Col id=\"outData\">dsHospitalRoom=dsHospitalRoom</Col><Col id=\"callbackFunc\">hroomCallbackFunc</Col></Row><Row><Col id=\"serviceID\">batchHroomProcess</Col><Col id=\"URL\">his::won/base/batchHroomProcess.do</Col><Col id=\"inData\">dsHroom=dsHroom:u</Col><Col id=\"callbackFunc\">gfnCallbackFunc</Col></Row></Rows>");
            ...
            obj = new Dataset("dsHospitalRoom", this);
            ...
            obj = new Combo("searchWardCombo", "absolute", "10.52%", "80", null, "28", "77.92%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("12");
            ...
            obj = new Combo("searchHroomCombo", "absolute", "30.39%", "80", null, "28", "58.05%", null, this);
            this.addChild(obj.name, obj);
            obj.set_taborder("14");
            ...
            obj = new Button("completeBtn", "absolute", "568", "720", "90", "32", null, null, this);
            obj.set_taborder("20");
            ...
            obj = new Button("cancelBtn", "absolute", "667", "720", "90", "32", null, null, this);
            obj.set_taborder("21");
            ...
            obj = new Layout("default", "", 770, 768, this,
            	...
            	function(p) {
            		...
            		p.set_titletext("HA_HospitalRoomAssignmentForm");
        ...
        // User Script
        this.addIncludeScript("HA_HospitalRoomAssignmentForm.xfdl", "scripts::commonScripts.xjs");
        this.registerScript("HA_HospitalRoomAssignmentForm.xfdl", function() {
        /********************************************************************
        *                                                                   *
        * 원무 병실 검색 팝업                         					*
        *                                                                   *
        ...
        ********************************************************************/
        ...
        this.loadIncludeScript("HA_HospitalRoomAssignmentForm.xfdl");
