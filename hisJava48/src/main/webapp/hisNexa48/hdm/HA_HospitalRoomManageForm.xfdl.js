(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"serviceID\" type=\"STRING\" size=\"256\"/><Column id=\"URL\" type=\"STRING\" size=\"256\"/><Column id=\"inData\" type=\"STRING\" size=\"256\"/><Column id=\"outData\" type=\"STRING\" size=\"256\"/><Column id=\"argument\" type=\"STRING\" size=\"256\"/><Column id=\"callbackFunc\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"serviceID\">findHroomList</Col><Col id=\"URL\">his::hdm/base/findHroomList.do</Col><Col id=\"outData\">dsHroom=dsHroom</Col><Col id=\"callbackFunc\">hroomCallbackFunc</Col></Row><Row><Col id=\"serviceID\">batchHroomProcess</Col><Col id=\"URL\">his::won/base/batchHroomProcess.do</Col><Col id=\"inData\">dsHroom=dsHroom:u</Col><Col id=\"callbackFunc\">gfnCallbackFunc</Col></Row></Rows>");
            ...
            obj = new Button("comboResetBtn", "absolute", "1026", "80", "102", "32", null, null, this);
            obj.set_taborder("5");
            ...
            obj = new Button("searchHroomBtn", "absolute", "1130", "80", "90", "32", null, null, this);
            obj.set_taborder("6");
        ...
        // User Script
        this.addIncludeScript("HA_HospitalRoomManageForm.xfdl", "scripts::commonScripts.xjs");
        this.registerScript("HA_HospitalRoomManageForm.xfdl", function() {
        /********************************************************************
        *                                                                   *
        * 원무 병실 관리                           						*
        *                                                                   *
        ...
        ********************************************************************/
        ...
        this.loadIncludeScript("HA_HospitalRoomManageForm.xfdl");
