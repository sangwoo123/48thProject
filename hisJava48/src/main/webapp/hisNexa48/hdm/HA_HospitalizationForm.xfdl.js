(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new GroupBox("GroupBox00", "absolute", "2%", "547", null, "191", "2.56%", null, this);
            obj.set_text("입원예약정보");
            obj.set_taborder("15");
            obj.style.set_background("#cfd8dcff");
            ...
            obj = new Grid("hosptlzRsvtGrid", "absolute", "2.8%", "583", null, "98", "3.36%", null, this);
            obj.set_taborder("16");
            ...
            obj = new Button("hosptlzRsvtBtn", "absolute", "89.44%", "694", null, "30", "3.52%", null, this);
            obj.set_taborder("73");
            obj.set_text("입원예약");
            obj.set_visible("false");
            obj.style.set_background("#455a64ff");
