(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("_ext_CreateDirectory", "absolute", "254", "340", "195", "50", null, null, this);
            obj.set_taborder("13");
        ...
        ****************************************************************************************************/
        this._ext_writeFile_onclick = function(obj,e)
        {
        	...
        	ret = Extension._ext_writeFile("d:/TEMP/__Encoding/日本/shift_jis.txt","国た外訪れた数者数者の数","shift-jis");
        	ret = Extension._ext_writeFile("d:/TEMP/__Encoding/日本/euc_kr.csv","한,글,안,녕,세,요","euc-kr");
        	ret = Extension._ext_writeFile("d:/TEMP/__Encoding/日本/3UTF8.csv","한,글,안,녕,세,요");
        	
        	ret = Extension._ext_writeFile("d:/TEMP/__Encoding/日本/4UTF8.csv","한,글,안,녕,세,요","utf-8");
        ...
        ****************************************************************************************************/
        ...
        //OUPUT			: bool : true 성공, false : 실패
        //////////////////////////////////////////////////////////
        this._ext_CreateDirectory_onclick = function(obj,e)
        {
        	var ret;
        	
        	//var strCreatePath = "D:/TEMP/__Encoding/日本語Test/日本語Test2/";
        	var strCreatePath = "D:\\TEMP\\__Encoding\\日本語Test\\日本語Test2\\";
         	ret = Extension._ext_CreateDirectory(strCreatePath);
         	trace ( "return : "  +ret );
        }
        ...
        this.on_initEvent = function()
        {
            ...
            this._ext_CreateDirectory.addEventHandler("onclick", this._ext_CreateDirectory_onclick, this);
